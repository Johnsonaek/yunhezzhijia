...
<template>
	<view>
		<!-- 广告图 -->
		<view class="banner"><image src="../../../static/index/topage/high2.png"></image></view>
		<!-- tabs -->
		<view class="bg-all">
			<view class="Tabs">
				<u-tabs class="one" bg-color="#fff" active-color="#222222" inactive-color="#666666" :list="Tabs" :is-scroll="true" :current="current" @change="change"></u-tabs>
			</view>
			<!-- 附近 -->
			<view class="nearby">
				<view class="nearby-right">
					附近
					<image src="../../../static/superior/superior2.png"></image>
				</view>
...
export default {
	data() {
		return {
			Tabs: ['精选', '美食', '电器', '美妆', '生活用品', '女装', '男装', '女靴'],
			current: 0
		};
	},
	methods: {
...
.bg-all {
	background-color: $uni-bggaoyong-color;
}
.Tabs {
	padding: 24upx;
	.one {
