	...
	<view>
		...
		<view class="details">
			<view class="details-left">
				...
				<text>月售331</text>
				<text>好评率96%</text>
				<view class="synopsis">产品简介XXXXXXXXXXXXXXXXXXXXXXXXXX</view>
			</view>
		...
		<view class="details-img">
			...
			<image src="../../static/index/index31.png"></image>
			<image src="../../static/index/index31.png"></image>
		</view>
		<!-- 到店消费 -->
		<view class="expense">
			<view class="money">到店消费，享受红包金</view>
			<text>返佣￥8</text>
			<text>返佣￥8</text>
		</view>
		<view class="rebate">
			<view class="explain">返利佣金说明</view>
			<text>
				返利佣金说明返利佣金说明返利佣金说明返利佣金说明返利佣返利
				返利佣金说明返利佣金说明返利佣金说明返利佣金说明返利佣返利
				返利佣金说明返利佣金说明返利佣金说明返利佣金说明返利佣返利
				返利佣金说明返利佣金说明返利佣金说明返利佣金说明返利佣返利
				返利佣金说明返利佣金说明返利佣金说明返利佣金说明返利佣返利
		...
		<!-- 占位 -->
		<view v-if="showHeader" class="placeone"></view>
		<view class="footer">
			...
			<navigator url="./order">
			<view class="footer-right">购买</view>
			</navigator>
		</view>
	</view>
</template>
