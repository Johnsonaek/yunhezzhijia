	...
	<view>
		<page title="频道页">
			...
			<view class="special relative z-index9">
				<!-- 宫格 -->
				<view class="qui-grids column5 gutter24-tb plr10 bg-white">
					<navigator hover-class="none" url="/pages/home/goods-list/goods-list" class="qui-grid">
						<view class="wh100"><image class="wh100 block" src="/static/business/business2.1.png"></image></view>
						<view class="fs24 mt10">礼品卡券</view>
					</navigator>
					<navigator hover-class="none" url="/pages/home/goods-list/goods-list"  class="qui-grid">
						<view class="wh100"><image class="wh100 block" src="/static/business/business2.2.png"></image></view>
						<view class="fs24 mt10">家用电器</view>
					</navigator>
					<navigator hover-class="none" url="/" class="qui-grid">
						<view class="wh100"><image class="wh100 block" src="/static/business/business2.3.png"></image></view>
						<view class="fs24 mt10">家具厨具</view>
					</navigator>
					<navigator hover-class="none" url="/" class="qui-grid">
						<view class="wh100"><image class="wh100 block" src="/static/business/business2.4.png"></image></view>
						<view class="fs24 mt10">珠宝首饰</view>
					</navigator>
					<navigator hover-class="none" url="/" class="qui-grid">
						<view class="wh100"><image class="wh100 block" src="/static/business/business2.5.png"></image></view>
						<view class="fs24 mt10">手机数码</view>
					</navigator>
					<navigator hover-class="none" url="/" class="qui-grid">
						<view class="wh100"><image class="wh100 block" src="/static/business/business2.6.png"></image></view>
						<view class="fs24 mt10">汽车用品</view>
					</navigator>
					<navigator hover-class="none" url="/" class="qui-grid">
						<view class="wh100"><image class="wh100 block" src="/static/business/business2.7.png"></image></view>
						<view class="fs24 mt10">健康保健</view>
					</navigator>
					<navigator hover-class="none" url="/" class="qui-grid">
						<view class="wh100"><image class="wh100 block" src="/static/business/business2.8.png"></image></view>
						<view class="fs24 mt10">休闲零食</view>
					</navigator>
					<navigator hover-class="none" url="/" class="qui-grid">
						<view class="wh100"><image class="wh100 block" src="/static/business/business2.9.png"></image></view>
						<view class="fs24 mt10">生鲜水果</view>
					</navigator>
					<navigator hover-class="none" url="/" class="qui-grid">
						<view class="wh100"><image class="wh100 block" src="/static/business/business2.10.png"></image></view>
						<view class="fs24 mt10">美妆个护</view>
					</navigator>
				</view>
				...
				<view class="qui-card panel bg-white-gray" style="min-height: 400rpx;">
					...
					<view class="plr12 pt0" style="margin-top: -12rpx;">
						<view class="qui-grids column2 gutter12">
							<view @click="goto('/pages/svideo/detail/detail?id='+item.goods_id)" class="qui-grid" v-for="(item, index) in list" :key="index">
