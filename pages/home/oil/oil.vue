			...
			<view >
				...
				<page title="一键加油">
					...
					<view class="jycontent" v-if="active == 0">
						...
						<view v-for="(item,index) in loadgasStation" class="infinite-list-item" :key="item.id" @click="gotoGasStation(item.range,item.gasId,item.gasName,item.gasLogoSmall  )"  v-if="!qiyouListShow && !fanshitrue"><view class="jiayouitem">
