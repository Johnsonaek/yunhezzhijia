<template>
	<div class="wrapper" :style="'top:'+statusBarHeight+'px'">
		<div class="header">
			<view class="back_div" @tap="navigateBack">
				<u-icon name="arrow-left" color="#000000" size="36"></u-icon>
				<!-- <image class="back_img" @click="back_city()" src="../../static/ceshi/youping/back_img.png"></image> -->
				<!-- <image src="../../static/ceshi/youping/back_img.png"></image> -->
			</view>
